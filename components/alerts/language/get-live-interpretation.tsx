...
import GetInterpretationCard from "./card/get-interpretation-card";

const GetInterPretation = ({ isOpen, onClose, data }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
      <div className="relative bg-white w-[700px] h-[400px] rounded-lg shadow-lg p-6 flex flex-col">
        ...
        <div className="w-[600px] h-[400px] p-2 text-center justify-center overflow-y-auto">
          <GetInterpretationCard isOpen={isOpen} onClose={onClose} data={data} />
        </div>
      </div>
    </div>
  );
